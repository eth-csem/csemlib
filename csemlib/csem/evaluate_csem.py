...
def evaluate_csem(x, y, z, regions=None, regions_2=None):
    ...
    # Add Japan
    ses3d = Ses3d(os.path.join(model_dir, 'japan_2016'),
                  grid_data.components)
    ses3d.eval_point_cloud_griddata(grid_data)

    # Add Europe
    ses3d = Ses3d(os.path.join(model_dir, 'europe_2013'),
                  grid_data.components)
    ses3d.eval_point_cloud_griddata(grid_data)
    ...
    # Add Iberia 2015
    ses3d = Ses3d(os.path.join(model_dir, 'iberia_2015'),
                  grid_data.components)
    ses3d.eval_point_cloud_griddata(grid_data)

    # Add Iberia 2017
    ses3d = Ses3d(os.path.join(model_dir, 'iberia_2017'),
                  grid_data.components)
    ses3d.eval_point_cloud_griddata(grid_data)
    ...
    # Add Japan 2017
    ses3d = Ses3d(os.path.join(model_dir, 'japan_2017'),
                  grid_data.components)
    ses3d.eval_point_cloud_griddata(grid_data)
