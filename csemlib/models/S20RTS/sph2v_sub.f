      subroutine sph2v_sub(xlt, xln, dep, dv, mfl, wasread)
c			use exodus 
      parameter (MXLH=36)
...
c     write(6,112) xlt,xln,dep,dv*100.
c     write(6,*) xln,xlt,dv*100.
112   format(f6.2,f9.2,f9.1,f9.2)
113   format(f9.2,f6.2,f9.2)
c     goto 10
