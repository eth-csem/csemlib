...
def test_csem_1d_background():
    ...
    reg04 = np.array([3.5432636006906293, 8.905243242819024, 8.905243242819024, 4.7699,
                      4.7699, 1.0, 143.0, 57823.0])
    reg05 = np.array([3.7237469157118186, 9.133916669282687, 9.133916669282687, 4.932487458797674,
                      4.932487458797674, 1.0, 143.0, 57823.0])
    reg06 = np.array([3.9758203735677293, 10.157825003924035, 10.157825003924035, 5.5159311881965145,
                      5.5159311881965145, 1.0, 143.0, 57823.0])
    ...
    reg11 = np.array([5.566455445926154, 13.716622269026377, 13.716622269026377, 7.26465059504689, 7.26465059504689,
                      1.0, 312.0, 57823.0])
    reg12 = np.array([9.903438401183957, 8.064788053141768, 8.064788053141768, 0.0, 0.0, 1.0, 0.0, 57823.0])
    reg13 = np.array([12.166331854652926, 10.35571579802768, 10.35571579802768, 0.0, 0.0, 1.0, 0.0, 57823.0])
...
def test_csem_1d_background_no_regions():
    ...
    reg09 = np.array([5.566455445926154, 13.716622269026377, 13.716622269026377, 7.26465059504689, 7.26465059504689,
                      1.0, 312.0, 57823.0])
    reg10 = np.array([12.166331854652926, 10.35571579802768, 10.35571579802768, 0.0, 0.0, 1.0, 0.0, 57823.0])
    reg11 = np.array([13.0885, 11.2622, 11.2622, 3.6678, 3.6678, 1.0, 84.6, 1327.7])
